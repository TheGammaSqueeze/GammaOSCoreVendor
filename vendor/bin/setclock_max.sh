...
echo "2184000" > /sys/devices/system/cpu/cpufreq/policy0/scaling_min_freq
...
echo "2301000" > /sys/devices/system/cpu/cpufreq/policy4/scaling_min_freq
...
echo "2704000" > /sys/devices/system/cpu/cpufreq/policy7/scaling_min_freq
