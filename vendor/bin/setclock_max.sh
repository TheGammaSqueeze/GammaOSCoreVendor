...
echo 900000000 > /sys/devices/platform/27800000.gpu/devfreq/27800000.gpu/min_freq
echo 900000000 > /sys/devices/platform/27800000.gpu/devfreq/27800000.gpu/max_freq

echo performance > /sys/devices/platform/27d00000.vop/devfreq/27d00000.vop/governor
echo 702000000 > /sys/devices/platform/27d00000.vop/devfreq/27d00000.vop/min_freq
echo 702000000 > /sys/devices/platform/27d00000.vop/devfreq/27d00000.vop/max_freq

echo performance > /sys/devices/platform/dmc/devfreq/dmc/governor
echo 2112000000 > /sys/devices/platform/dmc/devfreq/dmc/min_freq
