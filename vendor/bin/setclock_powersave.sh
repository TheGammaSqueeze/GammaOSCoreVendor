...
echo 400000000 > /sys/devices/platform/fde60000.gpu/devfreq/fde60000.gpu/max_freq
...
echo 297000000 > /sys/devices/platform/fdf80200.rkvdec/devfreq/fdf80200.rkvdec/max_freq
...
echo 396000000 > /sys/devices/platform/fe040000.vop/devfreq/fe040000.vop/max_freq
