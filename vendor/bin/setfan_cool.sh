...
kick_fan() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        ...
        # Short OFF to give a "jerk" on next pulse and let driver re-latch
        echo 0 > "$PWM"
        usleep 200000   # 0.2s OFF
...
# Hold at half speed once started
echo "$HALF_PWM" > "$PWM"
